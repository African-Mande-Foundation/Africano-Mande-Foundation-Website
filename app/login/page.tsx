            ...
            <div className="w-screen h-screen absolute border-0 flex items-center justify-center border-amber-500 z-10">
                <div className="p-2 md:p-4 lg:px-5 max-w-screen-xl w-full flex items-center justify-center h-full">
                    <div className="w-full items-center justify-center flex flex-col">
                        ...
                        <form  onSubmit={handleSubmit} className="p-2 w-full md:w-[400px] gap-y-2 flex flex-col mt-10">
                            {error && (
                            ...
                            <button disabled={isLoading} className=" cursor-pointer p-5 w-full h-12 items-center justify-center flex rounded-2xl bg-[#04663A] text-white _shadow font-bold text-xl mt-10 text-shadow-black/50 text-shadow-2xs ">
                                 {isLoading ? "Logging in..." : "Log In"}
                            </button>
                            <p className="text-black font-medium text-center text-shadow-2xl">
                                OR
                            </p>
                            <button disabled={isLoading} className="cursor-pointer p-5 w-full h-12 items-center justify-center flex gap-x-5 rounded-2xl bg-[#04B47F] text-white _shadow font-bold text-shadow-black/30 text-shadow-2xs text-base ">
