            ...
            <div className=" p-2 md:p-4 lg:px-5 max-w-screen-xl w-full relative flex flex-col gap-y-5 items-start justify-center h-auto">
                <div className="flex flex-col items-start justify-center w-full gap-y-5">
                    <div className="flex flex-col items-start justify-center w-full gap-y-3">
                        <div className="text-xl lg:text-2xl font-medium text-[#3b6907] items-center justify-center flex gap-x-2 mb-2" id="gallery"><div className="bg-[#3b6907] w-1 h-6"></div><p>Our Archives</p></div>
                ...
                <div className="flex flex-col items-start justify-center w-full gap-y-5" >
                    <div className="text-black font-bold text-2xl md:text-3xl lg:text-4xl" id="video">Video</div>
                    <Video/>
                </div>
            </div>
